...
def main():
    ...
    def callback1(ch, method, properties, body):
        ...
        response= general_agent_executor.invoke({"input": message, "chat_history": chat_history})
        chat_history.extend(
            [
        ...
        if 'Symptom' in general_res :
            ...
            response_causes = pandas_agent.invoke('고객의 입력으로부터 도출된 증상:'+symptom)
            send_message('\n'+response_causes["output"])
