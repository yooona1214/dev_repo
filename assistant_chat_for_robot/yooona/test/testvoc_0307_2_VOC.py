...
print("필요한 파일을 불러오는중...")
loader1 = CSVLoader('./data/LG_0313.csv')
#df = pd.read_csv('./data/LG_0313.csv')
...
while True:
    ...
    if 'Symptom' in general_res :
        ask_symptom = '{chat_history}를 분석하여, 고객의 증상을 최종 분류하여 고객에게 말해주고, {final_symptom}변수에 최종 분류된 증상을 넣어주세요.'
