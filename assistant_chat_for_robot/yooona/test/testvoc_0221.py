...
# tool 선언
rag = create_vector_store_as_retriever(data= issue_data, str1="KT_Robot_Customer_Issue_Guide", 
                                       str2="Please search for the customer's {user_input} at the symptom column and return the cause and action in same row.")
...
agent = create_react_agent_w_history(llm, tools, prompt)
