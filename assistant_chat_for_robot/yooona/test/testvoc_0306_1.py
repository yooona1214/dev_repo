...
There are a total of 3 experts you can call.
...
AI: [Symptom identification expert] The customer's symptom is, "My robot can't start and stops."
```
...
while True:
    ...
    if '증상 식별 전문가' in response["output"] :
        ask_cause = '그럼 고객의 원인은 무엇일까요?'
