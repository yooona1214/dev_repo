...
class LLMagent:
    ...
    def load_all(self):
        ...
        # tool 선언
        rag_issue = CreateVectorstore.create_vector_store_as_retriever(
            data=issue_data,
        ...
        rag_error = CreateVectorstore.create_vector_store_as_retriever(
            data=error_data,
            str1="KT_Robot_Error_Guide",
            str2="This is a data containing error code, causes of error code, and solutions for the error code.",
        )

        rag_manual = CreateVectorstore.create_vector_store_as_retriever_faiss(
