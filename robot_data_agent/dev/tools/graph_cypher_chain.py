...
openai_key = "ls__3b0b4639413547b1992222420ad58d30"
...
graph_chain = GraphCypherQAChain.from_llm(
    cypher_llm=ChatOpenAI(openai_api_key=openai_key, temperature=0, model_name="gpt-4"),
    qa_llm=ChatOpenAI(openai_api_key=openai_key, temperature=0, model_name="gpt-4"),
