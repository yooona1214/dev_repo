...
class _SQLPlotTool(BaseModel):
    query: str = Field(..., 
                       description="Tool for drawing graphs using sql data and pandas")
...
class SQLPlotTool(BaseSQLDatabaseTool, BaseTool):
    """
    """
    import pandas as pd
    from langchain_experimental.tools.python.tool import PythonAstREPLTool
    
    template: str = SQL_PLOT
    llm: BaseLanguageModel
    llm_chain: Any = Field(init=False)
    name: str = "sql_plot_tool"
    description: str = """
    Use this tool to plot the graph or table using sql data
    """
    args_schema: Type[BaseModel] = _SQLPlotTool
