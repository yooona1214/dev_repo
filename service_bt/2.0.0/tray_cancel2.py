...
class BB_init(py_trees.behaviour.Behaviour):
    ...
    def setup(self, **kwargs):
        ...
        py_trees.blackboard.Blackboard.set('previous_tree', 'tray_cancel2')
...
def go_to_next_state():
    ...
    seq_full_stuff.add_children([par_full_stuff_check, for_idle(alarm_type='cancel_return', tray_id=[1, 2])])
    ...
    seq_1_only_full.add_children([par_1_only_full, set_next_current_tray_id1, for_idle(alarm_type='cancel_return', tray_id=[2])])
    par_1_only_full.add_children([tray1_full_check, tray2_empty_check])

    seq_2_only_full.add_children([par_2_only_full, set_next_current_tray_id2, for_idle(alarm_type='cancel_return', tray_id=[1])])
    par_2_only_full.add_children([tray2_full_check, tray1_empty_check])

    seq_empty_stuff.add_children([par_empty_stuff_check, for_idle(alarm_type='cancel_return', tray_id=[1,2])])
...
def create_root():
    ...
    root_sel = py_trees.composites.Selector('tray_cancel2')
    ...
    main_seq.add_children([bb_start, pw_check_set,  LED_charging_f, LED_charging_r, get_tray_info, tray_action_start_tts, task_available_alarm, tray_manual_par, go_to_next_state()])
