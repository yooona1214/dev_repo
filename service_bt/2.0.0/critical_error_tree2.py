...
def msgs_to_BB_parallel():
    ...
    par.add_children([box_exception_to_BB, error_set_to_BB, button_status_to_BB, battery_state_to_BB, charging_state_to_BB, user_input_msgs_to_BB, 
                      admin_pw_req_msgs_to_BB,  emergency_button_info_to_BB, tray_open_status_to_BB, qr_result_to_BB, qr_state_to_BB])
...
def create_root():
    ...
    selector_error_alarm = PublishTopic(
        name='selector_error_alarm',
        topic_name='alarm_manager/set_alarm',
        topic_type = SetAlarm,
        msg_generate_fn=lambda: SetAlarm(
            level=5,
    ...
    seq_main.add_children([selector_error_alarm, multirobot_available_f, BGM_off_cancel, error_available, task_available_alarm, led_start_on_Emergency_front, led_start_on_Emergency_rear, error_unset, alarm_error_unset, Idling_error])
